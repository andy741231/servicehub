...
export default function HighlightsBlock({ content, blockType, id, order }) {
  const {
...
HighlightsBlock.craft = {
  displayName: 'HighlightsBlock',
  props: {
    content: makeDefaultBlockContent('highlights'),
