...
export default function TrustBarBlock({ content, blockType, id, order }) {
  const {
...
TrustBarBlock.craft = {
  displayName: 'TrustBarBlock',
  props: {
    content: makeDefaultBlockContent('trust-bar'),
    blockType: 'trust-bar',
    id: '',
    order: 0,
  },
